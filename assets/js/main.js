...
function QuillIsExists() {
	...
	if (editorElement) {
		...
		// Fungsi untuk mendapatkan konten dari Quill editor
		function getQuillContent() {
			if (editor && editor.root) {
				// Mengambil konten dalam format HTML
				return editor.root.innerHTML;
			}
			return ""; // Kembalikan string kosong jika editor tidak terinisialisasi
		}

		$("#submit-button").on("click", function () {
			var content = getQuillContent();
			$("#data-description").val(content);
			$("#hotel-form-edit").submit();
		});
	} else {
...
// Pastikan Quill diinisialisasi setelah DOM siap
