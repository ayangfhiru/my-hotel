...
<div
    ...
    <div class="flex flex-col space-y-5">
                ...
                <div
                    ...
                    <label for="listSearch" class="w-full">
                        <input
                            ...
                            class="search-input w-full border-none bg-bgray-100 px-0 text-sm tracking-wide text-bgray-600 placeholder:text-sm placeholder:font-medium placeholder:text-bgray-500 focus:outline-none focus:ring-0 dark:bg-darkblack-500 dark:text-white" />
                    </label>
                </div>
            </div>
            <div class="relative h-full flex-1">
                ...
                <div
                    ...
                    <ul>
                        <li
                            onclick="dateFilterAction('#table-filter')"
                            class="text-bgray-90 cursor-pointer px-5 py-2 text-sm font-semibold hover:bg-bgray-100 dark:text-white">
                            January
                        </li>
                        <li
                            onclick="dateFilterAction('#table-filter')"
                            class="cursor-pointer px-5 py-2 text-sm font-semibold text-bgray-900 hover:bg-bgray-100 dark:text-white">
                            February
                        </li>
        ...
        <!-- Table -->
        <div class="table-content w-full overflow-x-auto no-scrollbar">
            <table class="w-full">
                <tr
                    ...
                    <td class="px-6 py-5 xl:w-[165px] xl:px-0">
                        <div class="flex w-full items-center space-x-2.5">
                            <span
                                class="text-base font-medium text-bgray-600 dark:text-bgray-50">Payment</span>
                            <span>
                                <svg
                                    width="14"
                                    height="15"
                ...
                <?php foreach ($payments as $payment):; ?>
                    <?php
                    $dateBook = new DateTime($payment->booking_time);
                    $statusColor = [
                        'completed' => 'text-success-400',
                        'pending' => 'text-warning-300',
                        'failed' => 'text-[#FF4747]'
                    ];
                    $colorClass = isset($statusColor[$payment->payment_status]) ? $statusColor[$payment->payment_status] : '';
                    ?>
                    <tr
                        class="border-b border-bgray-300 dark:border-darkblack-400">
                        <td class="px-6 py-5 xl:px-0">
                        ...
                        <td class="px-6 py-5 xl:w-[165px] xl:px-0">
                            <div class="flex w-full items-center">
                                <span class="block rounded-md bg-success-50 px-4 py-1.5 text-sm font-semibold leading-[22px] capitalize <?= $colorClass ?> dark:bg-darkblack-500">
                        ...
                        <td class="px-6 py-5 xl:w-[165px] xl:px-0">
                            <div class="flex w-full items-center">
                                <span
                                    class="block rounded-md bg-[#FDF9E9] px-4 py-1.5 text-sm font-semibold leading-[22px] text-warning-300 dark:bg-darkblack-500">Cancelled</span>
                            </div>
                        </td>
                        <td class="py-5">
                            <div class="flex justify-center w-full">
                                <a href="<?= site_url("payments/$payment->payment_id/detail") ?>" type="button" onclick="dateFilterAction('#detail-payment')">
                                    <svg
                                        width="18"
                                        height="4"
                                        viewBox="0 0 18 4"
