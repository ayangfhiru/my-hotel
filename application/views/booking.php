...
<div class="py-7 grid sm:grid-cols-2">
    <div class="w-full px-3 py-5">
        ...
        <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
            ...
            <div class="border-b border-slate-200 col-span-full">
                <button type="button" data-acordion="1" class="btnAcordion w-full flex justify-between items-center py-5 text-slate-800">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span class="flex gap-x-2 items-center">
                                                <?= form_label(
                                                    $serviceName,
                                                    "service-$serviceId",
                                                    ['class' => 'text-sm font-medium text-gray-900 ms-3 cursor-pointer']
                                                ) ?>
    ...
    <div class="flex flex-col gap-y-3">
        <div class="w-full h-40 bg-gray-200 rounded-md overflow-hidden flex gap-x-5">
            <img src="<?= site_url("assets/images/thumbnail/" . ($room->thumbnail ?? 'default.jpg')) ?>" class="h-40 w-32 inline-block">
            <div class="py-3">
        ...
        <button id="payment-button" type="submit" class="bg-blue-400 py-2 text-white rounded shadow" data-url="<?= base_url() ?>">Bayar</button>
    </div>
</div>
<?= form_close(); ?>
