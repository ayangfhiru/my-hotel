    ...
    <div
        ...
        <div class="quick-access-wrapper relative">
            <div class="flex items-center space-x-[43px]">
                ...
                <div
                    class="hidden h-[48px] w-[1px] bg-bgray-300 dark:bg-darkblack-400 xl:block"></div>
                <!--                author-->
                <div
                    ...
                    <div
                        ...
                        <img
                            class="object-cover"
                            src="<?= base_url() ?>assets/images/avatar/profile-52x52.png"
                            alt="avater" />
                    </div>
                                ...
                                <a href="#">
                                    <div class="noti-item">
                                        <p
                                            ...
                                            <strong
                                                class="text-bgray-900 dark:text-bgray-50">James Eusobio</strong>
                                            send a new payment for
                                            <strong
                                                class="text-bgray-900 dark:text-bgray-50">SEO writing</strong>
                                            totaling
                                    ...
                                    <a href="#">
                                        <div class="flex space-x-3">
                                            <div
                                                ...
                                                <img
                                                    src="<?= base_url() ?>assets/images/avatar/inbox-1.png"
                                                    alt="avatar"
                                                    class="h-full w-full object-cover" />
                                                <div
                                                    class="absolute bottom-0 right-0 h-3 w-3 rounded-full border border-white bg-bgray-300"></div>
                                            </div>
                                            <div class="flex-1">
                                                <p
                                                ...
                                                <span
                                                    class="text-sm font-medium text-bgray-500 dark:text-bgray-50">23 mins ago</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a href="#">
                                        <div class="flex space-x-3">
                                            <div
                                                class="relative h-[48px] w-[48px] rounded-full">
                                                <img
                                                    src="<?= base_url() ?>assets/images/avatar/inbox-2.png"
                                                    alt="avatar"
                                                    class="h-full w-full object-cover" />
                                                <div
                                                    class="absolute bottom-0 right-0 h-3 w-3 rounded-full border border-white bg-success-300"></div>
                                            </div>
                                            <div class="flex-1">
                                                <p
                                                ...
                                                <span
                                                    class="text-sm font-medium text-bgray-500">23 mins ago</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a href="#">
                                        <div class="flex space-x-3">
                                            <div
                                                class="relative h-[48px] w-[48px] rounded-full">
                                                <img
                                                    src="<?= base_url() ?>assets/images/avatar/inbox-3.png"
                                                    alt="avatar"
                                                    class="h-full w-full object-cover" />
                                                <div
                                                    class="absolute bottom-0 right-0 h-3 w-3 rounded-full border border-white bg-success-300"></div>
            ...
            <div class="store-wrapper">
                ...
                <div
                    ...
                    <div class="relative w-full p-6">
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    class="absolute left-[10px] top-[5px] h-[200px] rounded-lg bg-success-200"></div>
                                <div
                        ...
                        <div class="flex justify-center">
                            <img
                                src="<?= base_url() ?>assets/images/avatar/members.png"
                                alt="members" />
                        </div>
                    </div>
                </div>
                                ...
                                <li class="w-full">
                                    <a href="settings.html">
                                        <div
                                            ...
                                            <div class="flex-1">
                                                <span
                                                    class="text-sm font-semibold text-bgray-900 dark:text-white">My Profile</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
