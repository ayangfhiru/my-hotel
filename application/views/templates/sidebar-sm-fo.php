<aside class="relative hidden w-[96px] bg-white dark:bg-black sm:block">
    <div class="sidebar-wrapper-collapse relative top-0 z-30 w-full">
        <div
            ...
            <a href="index.html">
                <img
                    src="<?= base_url() ?>assets/images/logo/logo-short.svg"
                    class="block dark:hidden"
                    alt="logo" />
                <img
                    src="<?= base_url() ?>assets/images/logo/logo-short-white.svg"
                            ...
                            <li class="item px-[43px] py-[11px]">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <a
                                            href="index-2.html"
                                            class="text-md inline-block py-1.5 font-medium text-bgray-600 hover:text-bgray-800">Dashboard Two</a>
                                    </li>
                                    <li>
                                        <a
                                            href="messages.html"
