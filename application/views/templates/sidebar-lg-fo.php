                ...
                <ul class="mt-2.5">
                    ...
                    <li class="item py-[11px] text-bgray-900 dark:text-white">
                        <a href="">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <span
                                        class="item-text text-lg font-medium leading-none">Bookings</span>
                                </div>
                                <span>
                                    <svg
                                        width="6"
                        ...
                        <ul
                            ...
                            <li>
                                <a
                                    href="<?= site_url("bookings/add-booking") ?>"
                                    class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">Booking</a>
                            </li>
                            <li>
                                <a
                                    href="<?= site_url("bookings/room") ?>"
                                    class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">Rooms</a>
                            </li>
                            <li>
                                <a
                                    href="<?= site_url("bookings/schedules") ?>"
                                    class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">Schedules</a>
                            </li>
                            <li>
                                <a
                                    href="<?= site_url("bookings/requests") ?>"
                                    class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">Requests</a>
                            </li>
                            <li>
                                <a
                                    href="statistics.html"
                                    class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">Extra Services</a>
                            </li>
                        </ul>
                    </li>
