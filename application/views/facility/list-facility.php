  ...
  <div
    ...
    <div class="flex flex-col space-y-5">
      <div class="flex h-[56px] w-full space-x-4">
          ...
          <div
            ...
            <label for="listSearch" class="w-full">
              <input
                type="text"
                id="listSearch"
                placeholder="Search bed name, or others..."
        ...
        <div class="relative h-full flex-1">
          <button
            data-modal-target="add-bed-modal" data-modal-toggle="add-bed-modal"
            type="button"
            class="flex h-full w-full items-center justify-center rounded-lg border border-bgray-300 bg-bgray-100 dark:border-darkblack-500 dark:bg-darkblack-500">
            <div class="flex items-center space-x-3">
              <span class="text-base font-medium text-success-300">Tambah Facility</span>
            </div>
          </button>
          <div
            id="table-filter"
          ...
          <?php foreach ($facilities as $facility):; ?>
            <tr
              ...
              <td class="px-6 py-5 xl:px-0">
                <div class="flex w-full items-center space-x-2.5">
                  <div
                    class="h-10 w-10 overflow-hidden rounded-full flex items-center justify-center">
                    <i class="<?= $facility->icon ?> fa-xl inine-block text-black dark:text-white object-cover"></i>
                  </div>
                  <p
...
<?php
$this->load->view('facility/modal-add-facility');
