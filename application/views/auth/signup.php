  ...
  <section class="bg-white dark:bg-darkblack-500">
    <div class="flex flex-col lg:flex-row justify-between min-h-screen">
      ...
      <div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
        <header>
          <a href="index.html" class="">
            <img src="<?= base_url() ?>assets/images/logo/logo-color.svg" class="block dark:hidden" alt="Logo" />
            <img src="<?= base_url() ?>assets/images/logo/logo-white.svg" class="hidden dark:block" alt="Logo" />
          </a>
        </header>
        ...
        <div class="max-w-[460px] m-auto pt-24 pb-16">
          ...
          <!-- Form -->
          <?= form_open(site_url('auth/registerProcess')); ?>
          ...
          <div class="flex justify-between mb-7">
            <div class="flex items-center gap-x-3">
              ...
              <label for="remember" class="text-bgray-600 dark:text-bgray-50 text-base">By creating an account, you agreeing to our
          ...
          <p class="text-center text-bgray-900 dark:text-bgray-50 text-base font-medium pt-7">
            ...
            <a href="<?= site_url('login') ?>" class="font-semibold underline">Sign In</a>
          </p>
          <nav
      ...
      <div class="lg:w-1/2 lg:block hidden bg-[#F6FAFF] dark:bg-darkblack-600 p-20 relative">
        ...
        <div class="mb-10">
          <img
            src="<?= base_url() ?>assets/images/illustration/signup.svg
            "
            alt="" />
        </div>
        <div>
