			...
			<div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
				...
				<div class="max-w-[450px] m-auto pt-16 pb-16">
					<header class="text-center mb-8">
						...
						<p
							class="font-urbanis text-base font-medium text-bgray-600 dark:text-bgray-50">
							Send, spend and save smarter
						</p>
					</header>
					<!-- Sign In with google / apple -->
					<div class="flex flex-col md:flex-row gap-4 hidden">
						<a
							href="#"
					...
					<div class="relative mt-6 mb-5">
						<div class="absolute inset-0 flex items-center">
							<div
								class="w-full border-t border-gray-300 dark:border-darkblack-400"></div>
						</div>
						<div class="relative flex justify-center text-sm">
							<span
								class="bg-white dark:bg-darkblack-500 px-2 text-base text-bgray-600">Or continue with</span>
						</div>
					</div>
					<?= form_open(site_url('auth/loginProcess')); ?>
					<div class="mb-4">
						<?= form_input([
							'id' => 'email',
							'name' => 'email',
					...
					<?= form_close(); ?>
					<p
						class="text-center text-bgray-900 dark:text-bgray-50 text-base font-medium pt-7">
						Don’t have an account?
						<a href="<?= site_url('register') ?>" class="font-semibold underline">Sign Up</a>
					</p>
					<nav
