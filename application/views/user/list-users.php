  ...
  <div
    ...
    <div class="flex flex-col space-y-5">
      <div class="flex h-[56px] w-full space-x-4">
        ...
        <div class="relative h-full flex-1">
          <button
            data-modal-target="add-staff-modal" data-modal-toggle="add-staff-modal"
            type="button"
            class="flex h-full w-full items-center justify-center rounded-lg border border-bgray-300 bg-bgray-100 dark:border-darkblack-500 dark:bg-darkblack-500">
            <div class="flex items-center space-x-3">
              <span class="text-base font-medium text-success-300">Tambah User</span>
            </div>
          </button>
          <div
            id="table-filter"
        ...
        <table class="w-full">
          <tr
            ...
            <td class="w-[165px] px-6 py-5 xl:px-0">
              <div class="flex w-full items-center space-x-2.5">
                <span
                  class="text-base font-medium text-bgray-600 dark:text-bgray-50">Role</span>
                <span>
                  <svg
                    width="14"
                    height="15"
...
<?php
$this->load->view('user/modal-add-staff');
