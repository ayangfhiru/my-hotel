                 ...
                 <div class="mb-5 flex items-center justify-between">
                     <div class="flex items-center space-x-[7px]">
                         <div class="icon">
                             <span>
                                 <img
                                     src="<?= base_url() ?>assets/images/icons/total-earn.svg"
                                     alt="icon" />
                             </span>
                         </div>
                         <span
                             class="text-lg font-semibold text-bgray-900 dark:text-white">Total earnings</span>
                     </div>
                     <div>
                         <img
                             src="<?= base_url() ?>assets/images/avatar/members-2.png"
                             alt="members" />
                     </div>
                 </div>
             ...
             <div class="rounded-lg bg-white p-5 dark:bg-darkblack-600">
                 <div class="mb-5 flex items-center justify-between">
                     <div class="flex items-center space-x-[7px]">
                         ...
                         <span
                             class="text-lg font-semibold text-bgray-900 dark:text-white">Total Spending</span>
                     </div>
                     <div>
                         <img
                             src="<?= base_url() ?>assets/images/avatar/members-2.png"
             ...
             <div class="rounded-lg bg-white p-5 dark:bg-darkblack-600">
                 <div class="mb-5 flex items-center justify-between">
                     <div class="flex items-center space-x-[7px]">
                         ...
                         <span
                             class="text-lg font-semibold text-bgray-900 dark:text-white">Spending Goal</span>
                     </div>
                     <div>
                         <img
                             src="<?= base_url() ?>assets/images/avatar/members-2.png"
             ...
             <div
                 ...
                 <div class="hidden items-center space-x-[28px] sm:flex">
                     <div class="flex items-center space-x-2">
                         <div
                             class="h-3 w-3 rounded-full bg-warning-300"></div>
                         <span
                             class="text-sm font-medium text-bgray-700 dark:text-bgray-50">Pending
                         </span>
                     </div>
                     <div class="flex items-center space-x-2">
                         <div
                             class="h-3 w-3 rounded-full bg-success-300"></div>
                         <span
                             class="text-sm font-medium text-bgray-700 dark:text-bgray-50">Signed
                         </span>
                     </div>
                     <div class="flex items-center space-x-2">
                         <div class="h-3 w-3 rounded-full bg-orange"></div>
                         <span
                             class="text-sm font-medium text-bgray-700 dark:text-bgray-50">Lost
                         </span>
                     </div>
                 </div>
                 <div class="date-filter relative">
                     <button
                         ...
                         <span
                             class="text-sm font-medium text-bgray-900 dark:text-white">Jan 10 - Jan 16</span>
                         <span>
                             <svg
                     ...
                     <div class="status">
                         <div class="mb-1.5 flex items-center justify-between">
                             <div class="flex items-center space-x-3">
                                 <div
                                     class="h-2.5 w-2.5 rounded-full bg-success-300"></div>
                                 <span
                         ...
                         <div class="mb-1.5 flex items-center justify-between">
                             <div class="flex items-center space-x-3">
                                 <div
                                     class="h-2.5 w-2.5 rounded-full bg-warning-300"></div>
                                 <span
                         ...
                         <div class="mb-1.5 flex items-center justify-between">
                             <div class="flex items-center space-x-3">
                                 <div
                                     class="h-2.5 w-2.5 rounded-full bg-bgray-200"></div>
                                 <span
                         ...
                         <td class="px-6 py-5 xl:px-0">
                             <div class="flex w-full items-center space-x-2.5">
                                 <div
                                     class="h-10 w-10 overflow-hidden rounded-full">
                                     <img
                                         src="<?= base_url() ?>assets/images/avatar/user-40x40-1.png"
                                         alt="avatar"
                                         class="h-full w-full object-cover" />
                                 </div>
                                 <p
                         ...
                         <td class="px-6 py-5 xl:px-0">
                             <div class="flex w-full items-center space-x-2.5">
                                 <div
                                     class="h-10 w-10 overflow-hidden rounded-full">
                                     <img
                                         src="<?= base_url() ?>assets/images/avatar/user-40x40-2.png"
                                         alt="avatar"
                                         class="h-full w-full object-cover" />
                                 </div>
                                 <p
         ...
         <div class="my-wallet mb-8 w-full">
             ...
             <div class="flex justify-center">
                 <div class="card-slider relative w-[280px] md:w-[340px]">
                     <div class="w-full">
                         <img
                             src="<?= base_url() ?>assets/images/payments/card-1.svg"
                             alt="card" />
                     </div>
                     <div class="w-full">
                         <img
                             src="<?= base_url() ?>assets/images/payments/card-2.svg"
                             alt="card" />
                     </div>
                     <div class="w-full">
                         <img
                             src="<?= base_url() ?>assets/images/payments/card-3.svg"
                             alt="card" />
                     </div>
                 </div>
             </div>
         ...
         <div class="w-full">
             ...
             <div class="payment-select relative mb-3">
                 <button
                     ...
                     <div class="flex items-center space-x-2">
                         <span>
                             <img
                                 src="<?= base_url() ?>assets/images/payments/master-mini.svg"
                                 alt="master" />
                         </span>
                         <span
             ...
             <div
                 ...
                 <div
                     ...
                     <span
                         class="text-2xl font-bold text-bgray-900 dark:text-white">$</span>
                     <label class="w-full">
                         <input
                             type="text"
                     ...
                     <div>
                         <img
                             src="<?= base_url() ?>assets/images/avatar/members-3.png"
                             alt="members" />
                     </div>
                 </div>
             </div>
                 ...
                 <div class="flex justify-start">
                     <div class="flex items-end space-x-3">
                         <div class="flex items-center space-x-2">
                             ...
                             <div>
                                 <img
                                     src="<?= base_url() ?>assets/images/others/mp3.png"
                                     class="block dark:hidden"
                                     alt="mp3" />
                                 <img
                                     src="<?= base_url() ?>assets/images/others/mp3-dark.png"
